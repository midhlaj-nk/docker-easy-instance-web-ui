        ...
        <div className="flex gap-x-2 justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              className="p-2.5 rounded-full hover:bg-[var(--input-bg)] text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-all duration-300"
            ...
            <div className="relative" ref={notificationDropdownRef}>
              <button
                ...
                className="relative p-2.5 rounded-full hover:bg-[var(--input-bg)] text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-all duration-300"
